...
import { totalBillingSuppliersByYear } from "../../../src/database/ReportService/totalBillingSuppliersByYear.js";
...
describe("Report Service Tests - totalBillingSuppliersByYear", () => {
    ...
    beforeEach(async () => {
        ...
        const transaction1supplier: TransactionType = { id: 1, supplierId: 1, date: new Date(2024, 2, 1), items: [furniture1, furniture2], total: 270, type: "purchase" };
        const transaction2supplier: TransactionType = { id: 2, supplierId: 1, date: new Date(2024, 2, 3), items: [furniture2, furniture3], total: 370, type: "purchase" };
        const transaction3supplier: TransactionType = { id: 3, supplierId: 2, date: new Date(2022, 6, 27), items: [furniture1, furniture3], total: 270, type: "purchase" };
    ...
    it("should get 2 transactions for the year 2024", async () => {
        const report = new totalBillingSuppliersByYear();
