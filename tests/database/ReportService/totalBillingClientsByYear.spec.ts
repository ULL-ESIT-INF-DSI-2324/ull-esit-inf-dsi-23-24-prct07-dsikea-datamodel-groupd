...
describe("Report Service Tests - totalBillingClientsByYear", () => {
    ...
    beforeEach(async () => {
        ...
        const transaction1Client: TransactionType = { id: 1, clientId: 1, date: new Date(2024, 2, 1), items: [furniture1, furniture2], total: 270, type: "sale" };
        const transaction2Client: TransactionType = { id: 2, clientId: 1, date: new Date(2024, 2, 3), items: [furniture2, furniture3], total: 370, type: "sale" };
        const transaction3Client: TransactionType = { id: 3, clientId: 2, date: new Date(2022, 6, 27), items: [furniture1, furniture3], total: 270, type: "sale" };
